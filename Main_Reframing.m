...
for is=1:ns
    ...
    np=12;  %np = number of periods to make a window.
...
hold on
 ...
 errorbar(log10(Tmean),mstrikeP,sstrikeP,sstrikeP,'.-m')
 xlabel('Period (log10)','FontSize',12),ylabel('Degrees','FontSize',12)
